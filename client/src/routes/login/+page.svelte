...
<main class="flex flex-col">
    ...
    <form class="flex justify-between" method="POST" use:enhance>
        <button class="btn btn-square btn-primary btn-lg" formaction="?/login&provider=google">
        ...
        <button class="btn btn-square btn-primary btn-lg" formaction="?/login&provider=discord">
