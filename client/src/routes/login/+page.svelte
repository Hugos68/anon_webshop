...
<main class="flex flex-col items-center justify-center mb-5 mt-20">
    ...
    <form class="flex flex-col" action="?/login" method="POST" use:enhance={handleLogin}>
        ...
        <button class="btn-primary mt-8" type="submit">Login</button>
    </form>
    <p class="text-black font-bold dark:text-slate-300 my-10">Third-party login:</p>
    <form class="flex gap-10" method="POST" use:enhance>
        <button class="btn-square" formaction="?/login&provider=google">
        ...
        <button class="btn-square" formaction="?/login&provider=discord">
        ...
        <button class="btn-square" formaction="?/login&provider=github">
