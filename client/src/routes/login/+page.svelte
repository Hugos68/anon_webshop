...
<main class="flex flex-col justify-center items-center">
    ...
    <p class="font-bold my-10">Third-party login:</p>
    <form class="flex gap-10" method="POST" use:enhance>
        <button class="btn btn-square btn-primary" formaction="?/login&provider=google">
        ...
        <button class="btn btn-square btn-primary" formaction="?/login&provider=discord">
        ...
        <button class="btn btn-square btn-primary" formaction="?/login&provider=github">
